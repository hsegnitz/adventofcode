...
public class Part2 {
    ...
    public static void main(String[] args) {
        ...
        targetWeight = sum / 4;  //  actually this worked only by accident, I guess with a different data set it wouldn't have, as we didn't really check fully if the gifts would be distributable
