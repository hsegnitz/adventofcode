...
public class Part1 {
        ...
        public long run() {
            while (true) {
                ...
                switch (inst.getOpcode()) {
                    case 1:
                        this.program.put(inst.getOutPosition(), inst.getParameterValue1() + inst.getParameterValue2());
                    ...
                    case 3:
                        ...
                        this.program.put(inst.getOutPosition(), inp);
                        this.pointer += inst.getStep();
                        break;
                    case 4:
                        this.pointer += inst.getStep();
                    ...
                    case 7:
                        if (inst.getParameterValue1() < inst.getParameterValue2()) {
                            this.program.put(inst.getOutPosition(), 1L);
                        } else {
                            this.program.put(inst.getOutPosition(), 0L);
                        }
                        this.pointer += inst.getStep();
                        break;
                    case 8:
    ...
    private static class Instruction {
        ...
        public long getParameterValue1() {
            if (parameterMode1 == 1) {
        ...
        public long getParameterValue2() {
            if (parameterMode2 == 1) {
        ...
        public long getParameterValue3() {
            if (parameterMode3 == 1) {
