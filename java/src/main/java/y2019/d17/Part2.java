...
C = L12,L8,R10
    ...
    private static String programProgram = "A,B,B,C,C,A,B,B,C,A\n"
        + "R,4,R,12,R,10,L,12\n"
        + "L,12,R,4,R,12\n"
        + "L,12,L,8,R,10\n"
        + "n\n";
    ...
    public static void main(String[] args) {
        ...
        for (Integer c: programProgram.chars().boxed().collect(toList())) {
            System.out.print("" + c + " ");
            program.addInput(c);
        }
