...
// strategy: we start by 1 trillion divided by part 1 result. and then see if that is too much or too little and then walk:
// 1.112.155

function testForOneTrillion(int $fuel, $recipes): int {
    $inventoryOfNeeds = ['FUEL' => $fuel];
    $excessAmounts = [];
    ...
    return $inventoryOfNeeds['ORE'];
}

echo testForOneTrillion(2390226, $recipes);
